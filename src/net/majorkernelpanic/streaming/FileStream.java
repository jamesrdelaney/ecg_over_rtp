...
public abstract class FileStream implements Stream {
	...
	protected static final String TAG = "FileStream";

	/** FileStream forwards data to a packetizer through a LocalSocket. */
	public static final int MODE_STREAMING = 0;

	/** FileStream will just act as a regular MediaRecorder. */
	public static final int MODE_DEFAULT = 1;

	/** The packetizer that will read the output of the file and send RTP packets over the network. */
	...
	/**
	 * Sets the mode of the {@link FileStream}.
	...
	public void start() throws IllegalStateException {
		...
		try {
			if (mode==MODE_STREAMING) {
				...
				// This is where the file output should be sent to the packetizer I think...
