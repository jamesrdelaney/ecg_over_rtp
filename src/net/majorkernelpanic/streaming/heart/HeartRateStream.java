...
import net.majorkernelpanic.streaming.rtp.HeartRatePacketizer;
import android.hardware.Camera.CameraInfo;
import android.media.MediaRecorder;

/**
 * A class for streaming HeartRate from a file (currently using RTP.
 ...
 */
public class HeartRateStream extends HeartStream {
	 ...
	 * @throws IOException
	 */	
	public HeartRateStream() throws IOException {
		super();
		//setVideoEncoder(MediaRecorder.VideoEncoder.H263);
		mPacketizer = new HeartRatePacketizer();
	}
