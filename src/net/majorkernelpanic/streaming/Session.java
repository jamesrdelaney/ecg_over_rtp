...
public class Session {
	...
	private HeartStream mHeartStream = null;
	...
	public void addHeartTrack(HeartStream track) {
		mHeartStream = track;
	}
	...
	public HeartStream getHeartTrack() {
		return mHeartStream;
	}	
	...
	public String getSessionDescription() throws IllegalStateException, IOException {
		...
		synchronized (sLock) {
			...
			// James: Possibly add description of heart track here
	...
	public boolean isStreaming() {
		if ( (mAudioStream!=null && mAudioStream.isStreaming()) || (mVideoStream!=null && mVideoStream.isStreaming()) || (mHeartStream!=null && mHeartStream.isStreaming()) )
			return true;
		else 
			return false;
	}
	...
	public void flush() {
		synchronized (sLock) {
			...
			if (mHeartStream!=null) {
				mHeartStream.stop();
				mHeartStream.release();
				mHeartStream = null;
			}
		}
	}
